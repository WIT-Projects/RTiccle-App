    ...
    return (
        <>
            ...
            <SearchBar
                ...
                setExistResult={setExistResult}
                placeholderContext="#태그이름, 티끌이름"></SearchBar>
            {pressSearchBtn ? existResult ? <SearchExistResultList isGroupDetail={true} /> : <NotExistTiccle /> : group.ticcleNum != 0 ? <GroupDetailTiccleList ticcleList={list} /> : <ZeroTiccle />}
